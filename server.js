...
function getLocations(req, res) {
    l++
  console.log(`${req.originalUrl}: #${l}`)
  res.json(locations)
}

function getCharacterById(req, res) {
  res.json(characters.filter(character => character.id === req.params.id)) 
}

function getEpisodeById(req, res) {
  res.json(episodes.filter(episode => episode.id === req.params.id)) 
}
...
// ////////////// ENDPOINTS //////////////
// ////////////// ENDPOINTS //////////////
app.get('/api/character', getCharacters)
app.get('/api/character/:id', getCharacterById)
app.get('/api/episode', getEpisodes)
app.get('/api/episode/:id', getEpisodeById)
